...
class DP_Image_Empty_Latent_Switch_Flux:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "IPadapter_Mode": (
                    ["IPadapter_OFF", "IPadapter_ON"],
                    {"default": "IPadapter_OFF"},
                ),
                "ControlNet_mode": (
                    ["Controlnet_OFF", "Controlnet_ON"],
                    {"default": "Controlnet_OFF"},
                ),
                "img2img_strength": (
                    "FLOAT",
    ...
    def switch(
        ...
        **kwargs,
        ...
        mode_map = {"Txt2Image": 0, "Img2Img": 1}
        ...
        controlnet_output = (
            None
            if ControlNet_mode == "Controlnet_OFF"
            else kwargs.get("controlnet_condition")
        )
