...
class DP_Crazy_Prompt_Mixer:
    ...
    def split_into_chunks(self, words, chunk_size):
        ...
        while i < len(words):
            ...
            if i + 1 < len(words):
                ...
                if any(phrase in next_pair.lower() for phrase in [
                    "ultra detailed", "highly detailed", "high quality",
                    "cinematic lighting", "dramatic lighting", "professional photo",
    ...
    def mix_prompt(self, chunk_size, generation_mode, mixing_mode="chunks", input_prompt=None):
        try:
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "DP_Crazy_Prompt_Mixer": "Crazy Prompt Mixer"
}
