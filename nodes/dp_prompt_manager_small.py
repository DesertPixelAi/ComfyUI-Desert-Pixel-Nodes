...
class DP_Prompt_Manager_Small:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "prompt_mode": (
                    ["Prompt_Manager_Prompt", "Random_Prompt", "Other_Prompt"],
                ),
                "subject": (
                    "STRING",
        ...
        try:
            ...
            if not lines:
                if processed_scene:
                    ...
                    return (
                        self.apply_weight(processed_scene, weight),
                        filename,
                        "",
                        processed_scene,
                    )
            ...
            if find_replace_subject in processed_scene:
                processed_scene = processed_scene.replace(
                    find_replace_subject, selected_subject
                )
            ...
            return (
                self.apply_weight(full_prompt, weight),
                filename,
                selected_subject,
                processed_scene,
            )
