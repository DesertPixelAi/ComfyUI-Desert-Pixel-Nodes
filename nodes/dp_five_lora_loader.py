...
class DP_Five_Lora:
    ...
    def apply_lora(self, model, clip, loader_state, Lora_01,
        ...
        if strength_control is None:
            raise ValueError("LoRA Strength Controller not connected. Please connect a DP_Lora_Strength_Controller to use this node.")

        # Get strength values from control input
        Lora_01_Strength, Lora_02_Strength, Lora_03_Strength, Lora_04_Strength, Lora_05_Strength = strength_control
