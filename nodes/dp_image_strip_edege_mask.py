    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "output_mode": (
                    ["separate_masks", "combined_mask"],
                    {"default": "separate_masks"},
                ),
            }
        }
            ...
            if is_horizontal:
                ...
                if feather > 0:
                    ...
                    if center_width > 0:
                        ...
                        mask[:, :, : mask_width // 2] *= left_feather[
                            :, :, : mask_width // 2
                        ]
                        mask[:, :, mask_width // 2 :] *= right_feather[
                            :, :, -mask_width // 2 :
                        ]
                ...
                mask_width = processed_images[i].shape[
                    2
                ]  # Define mask_width for vertical case
                ...
                if feather > 0:
                    ...
                    if center_height > 0:
                        ...
                        mask[:, : mask_height // 2, :] *= top_feather[
                            :, : mask_height // 2, :
                        ]
                        mask[:, mask_height // 2 :, :] *= bottom_feather[
                            :, -mask_height // 2 :, :
                        ]
