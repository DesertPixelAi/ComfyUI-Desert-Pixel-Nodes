...
class DP_Image_Empty_Latent_Switch_SDXL:
    ...
    def switch(self, Mode_Settings, Model_mode, ControlNet_mode,
        ...
        model_map = {
            "Model_Dry": kwargs.get("Model_Dry"),
        ...
        if selected_model is None:
            for model in [kwargs.get("Model_Dry"), kwargs.get("Model_Lora"), kwargs.get("Model_Ip_Adapter")]:
