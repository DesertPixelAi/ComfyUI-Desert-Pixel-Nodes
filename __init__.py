...
try:
    ...
    # Import nodes directly from the nodes directory
    from .nodes.dp_animation_calculator_5inputs import DP_Animation_Calculator_5_Inputs
    from .nodes.dp_animation_int_selectors import DP_Transition_Frames_Selector, DP_Diff_Int_8step_selector
    ...
    from .nodes.dp_draggable_floats import (DP_Draggable_Floats_1, DP_Draggable_Floats_2, 
    ...
    from .nodes.dp_string_with_switch import DP_String_With_Switch, DP_2_String_Switch, DP_String_Text
